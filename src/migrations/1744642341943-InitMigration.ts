...
export class InitMigration1744642341943 implements MigrationInterface {
    name = 'InitMigration1744642341943'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "franchises" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "company_id" uuid NOT NULL, "name" character varying(255) NOT NULL, "owner_id" character varying NOT NULL, "address" text NOT NULL, "phone" character varying(20) NOT NULL, "qr_code" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "registration_id" integer NOT NULL, "location" character varying(255) NOT NULL, CONSTRAINT "UQ_7db53abe050a27f927ab5ffb406" UNIQUE ("phone"), CONSTRAINT "UQ_4c8c7c0824e07135dc47d3a14af" UNIQUE ("qr_code"), CONSTRAINT "PK_5ff74e1ad0637c499c4ed139e2c" PRIMARY KEY ("id"))`);
